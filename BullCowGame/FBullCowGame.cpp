...
void FBullCowGame::GetHiddenWord(int32 number)
{
	TMap <int32, FString> ChoiceToWord { { 3,"cat" },{4,"cold"}, {5,"break"} ,{6,"planet"} };
	MyHiddenWord = ChoiceToWord[number];

}

int32 FBullCowGame::GetMaxTries() const 
{ 
	TMap <int32, int32> WordLengthToMaxTry{ {3,4}, {4,7}, {5,10} ,{6,16} };
